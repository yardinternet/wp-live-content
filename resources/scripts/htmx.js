const htmx = ( function () {
	...
	function we( e, t ) {
		...
		if ( n ) {
			...
			if ( r.length === 0 ) {
				O(
					'The selector "' + n + '" on ' + t + ' returned no matches!'
				);
				return [ ve ];
			}
			return r;
			...
			if ( le( e ) && r.cancelled !== true ) {
				if (
					! gt(
						n,
						e,
						Mt( 'hx:poll:trigger', { triggerSpec: n, target: e } )
					)
				) {
					t( e );
				}
	...
	function on( t, n, r, o, i ) {
		...
		if ( tn( o ) ) {
			...
			if ( o instanceof HTMLSelectElement && o.multiple ) {
				e = M( o.querySelectorAll( 'option:checked' ) ).map(
					function ( e ) {
						return e.value;
					}
				);
	...
	function de( t, n, r, o, i, D ) {
		...
		if ( B ) {
			...
			if (
				x === null ||
				! he( r, 'htmx:prompt', { prompt: x, target: c } )
			) {
				oe( s );
				m();
				return e;
